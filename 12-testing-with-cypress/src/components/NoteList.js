...
const NoteList = () => {
  ...
  return (
    <div className='container mt-3'>
      ...
      <div className='mt-3' data-test='notes-list'>
        {
          notes.length === 0 ? (
                ...
                <div className='col-md-4' key={note.id}>
                  <div className='card mb-3' style={{ minHeight: '300px' }}>
                    <div className='card-body d-flex flex-column justify-content-between' style={{ height: '100%' }}>
                      <div>
                        <h5 data-test='note-title' className='card-title'>{note.title}</h5>
                        <p data-test='note-content' className='card-text'>{note.content}</p>
                      </div>
